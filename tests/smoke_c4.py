...
from modules.loan_module import (
    compute_effective_due, is_overdue_with_grace,
    calc_overdue_days, calc_late_fee, calculate_late_fee
)

print("effective_due:", compute_effective_due("2025-09-25", 5))               # → 2025-09-30
print("overdue A :", is_overdue_with_grace(date(2025,9,29),"2025-09-25",5))   # → False
print("overdue B :", is_overdue_with_grace(date(2025,9,29),"2025-09-20",3))   # → True
